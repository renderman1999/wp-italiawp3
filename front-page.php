...
if ( get_theme_mod( 'active_section_dataset_slider', true ) ) {
	get_template_part( 'template-parts/section-dataset-slider' );
}

if ( get_theme_mod( 'active_section_dataset_categories', true ) ) {
	get_template_part( 'template-parts/section-dataset-categories' );
}

if ( get_theme_mod( 'active_section_dataset_catalog', true ) ) {
	get_template_part( 'template-parts/section-dataset-catalog' );
}
