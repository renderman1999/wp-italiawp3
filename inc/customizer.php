...
function italiawp2_customize_register($wp_customize) {
	...
	/* Dataset in evidenza (slider - richiede plugin Open Data PA) */
    $wp_customize->add_setting('active_section_dataset_slider', array(
        'default' => true, 'capability' => 'edit_theme_options', 'sanitize_callback' => 'italiawp2_sanitize_checkbox'
    ));
    $wp_customize->add_control('active_section_dataset_slider', array(
        'label' => 'Slider Dataset in evidenza (home, sotto la navbar)',
        'type' => 'checkbox', 'section' => 'site_settings', 'settings' => 'active_section_dataset_slider'
    ));

	/* Naviga i dati per categoria tematica (home, prima del catalogo) */
    $wp_customize->add_setting('active_section_dataset_categories', array(
        'default' => true, 'capability' => 'edit_theme_options', 'sanitize_callback' => 'italiawp2_sanitize_checkbox'
    ));
    $wp_customize->add_control('active_section_dataset_categories', array(
        'label' => 'Sezione Naviga i dati per categoria tematica (home, prima del catalogo)',
        'type' => 'checkbox', 'section' => 'site_settings', 'settings' => 'active_section_dataset_categories'
    ));

	/* Catalogo dataset (home, sotto lo slider) */
    $wp_customize->add_setting('active_section_dataset_catalog', array(
        'default' => true, 'capability' => 'edit_theme_options', 'sanitize_callback' => 'italiawp2_sanitize_checkbox'
    ));
    $wp_customize->add_control('active_section_dataset_catalog', array(
        'label' => 'Sezione Catalogo dataset (home, sotto lo slider)',
        'type' => 'checkbox', 'section' => 'site_settings', 'settings' => 'active_section_dataset_catalog'
    ));
